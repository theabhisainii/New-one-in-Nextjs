          ...
          <div className="grid gap-8 lg:grid-cols-[1.2fr_0.9fr]">
            ...
            <div className="relative overflow-hidden rounded-[1.75rem] bg-gradient-to-tr from-blue-600 to-slate-900 p-8 text-white sm:p-10">
              ...
              <div className="relative space-y-6">
                <div>
                  <p className="text-sm uppercase tracking-[0.3em] text-blue-100/80">Account setup</p>
                  <h2 className="mt-4 text-2xl font-semibold sm:text-3xl">Start with confidence</h2>
                </div>
                ...
                <div className="space-y-4 rounded-3xl bg-white/10 p-5 text-sm text-blue-100 shadow-inner shadow-slate-950/10">
                  <div>
                    ...
                    <p className="mt-1 text-blue-100/80">Create your account quickly and get access to the dashboard.</p>
                  </div>
                  <div>
                    <p className="font-semibold">Responsive design</p>
                    <p className="mt-1 text-blue-100/80">A modern signup flow that looks great on every screen.</p>
                  </div>
                </div>
                ...
                <div className="rounded-3xl border border-white/10 bg-white/10 p-5">
                  ...
                  <p className="mt-3 text-sm leading-6 text-blue-100/90">
                    If you need assistance, check your details or reach out to support for help completing your registration.
                  </p>
                </div>
              </div>
            </div>
